...
- `#`의 개수로 표현하거나 `<h1><lh1>`의 형태로 표현 가능합니다.
...
### 1.3 Code Block
> 코드 블럭은 작석한 코드를 정리하거나 강조하고 싶은 부분을 나타낼 때 사용합니다. 인라인과 블럭 단위로 구분할 수 있습니다.
- Inline
  - 인라인 블럭으로 처리하고 싶은 부분을 ` (백틱)으로 감싸줍니다.
- Block
  - `(백틱)을 3번 입력하고 `Enter`를 눌러
...
![A(1)](A%20(1).jpg) ![A(2)](A%20(2).jpg)![A(3)](A%20(3).jpg)
### 1.5 Link
...
### 1.7 기타
**인용문**
- `>`을 입력하고 `spase`키를 누릅니다.

> git은 컴퓨터 파일의 변경사항을 추적하고 여러 명의 사용자들 간에 해당 파일들의 작업을 조율하기 위한 분산 버전 관리 시스템이다.
- 인용문 안에 인용문을 중첩해서 사용할 수 있습니다.
 > $ git commit -m "frst nommit"
 > > $ git push origin master
 > > > $ git push origin master
 **수평선**
 - `---`,`***`,`___`을 입력하여 작성합니다.
